...
clock_h = {
    ...
    txt_radius=14,
    txt_weight=1,                  txt_size=48,
    txt_fg_colour=0x91ff98,        txt_fg_alpha=0.3,
...
clock_m = {
    ...
    graph_bg_colour=0x000000,      graph_bg_alpha=0.65,
    graph_fg_colour=0x91FF98,      graph_fg_alpha=0.8,
    txt_radius=37,
    txt_weight=1,                  txt_size=26.0,
    txt_fg_colour=0x91ff98,        txt_fg_alpha=0.5,
    graduation_radius=62,
    graduation_thickness=0,        graduation_mark_thickness=2,
    graduation_unit_angle=30,
    graduation_fg_colour=0x000000, graduation_fg_alpha=0.2,
    },
}
-- SECONDS
clock_s = {
    ...
    graph_fg_colour=0x91FF98,      graph_fg_alpha=0.55,
    txt_radius=45,
    txt_weight=0,                  txt_size=15.0,
    txt_fg_colour=0x91ff98,        txt_fg_alpha=0.9,
    graduation_radius=0,
